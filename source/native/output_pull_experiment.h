...
#ifndef MFG_UNLOCK_OUTPUT_PULL_EXPERIMENT
#define MFG_UNLOCK_OUTPUT_PULL_EXPERIMENT 0
#endif
#ifndef MFG_UNLOCK_OUTPUT_PULL_TELEMETRY
#define MFG_UNLOCK_OUTPUT_PULL_TELEMETRY 0
#endif

namespace midpoint_fix
{
// Private experimental telemetry. This is not part of the public control ABI.
struct OutputPullSnapshot
{
    bool candidate = MFG_UNLOCK_OUTPUT_PULL_EXPERIMENT != 0;
